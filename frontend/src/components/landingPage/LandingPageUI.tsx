...
function LandingPageUI() {
  return (
    ...
    <div className='relative  min-h-screen'>
      <div className='text-white/100 w-full bg-transparent z-40 absolute animate-fade-down animate-duration-[2000ms] animate-delay-[400ms] animate-ease-in-out animate-normal'>
        <NavbarUI />
      </div>
      ...
      <div className='z-30 absolute   lg:w-full lg:h-screen flex justify-center '>
        <img className='object-cover mt-20 animate-fade-up animate-duration-[2000ms] animate-delay-[400ms] animate-ease-in-out animate-normal' src="src/assets/CA.png" />
      </div>
      ...
      <div className='z-30 absolute w-full h-screen justify-center p-20 flex flex-col overflow-hidden'>
        ...
        <div className='w-full'>
          <div className='flex justify-between mt-[150px] ml-20 mr-20  text-white'>
            <div className='mt-10 '>
              <h2 className='animate-fade-up animate-duration-[2000ms] animate-delay-[400ms] animate-ease-in-out animate-normal'>@2026</h2>
